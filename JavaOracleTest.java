	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 String dbURL = "jdbc:oracle:thin:@(DESCRIPTION =(ADDRESS_LIST =(ADDRESS =(PROTOCOL=TCP)(HOST=acadoradbprd01.dpu.depaul.edu)(PORT=1521)))"
	       ...
	       JTextField candyText = new JTextField ("(e.g. Snickers)");
	       candyText.setBounds(70, 50, 165, 25);
	       panel.add(candyText);
	       
	       
	       JLabel quantoff = new JLabel("Quantity");
	       quantoff.setBounds(10,80,80,25);
	       panel.add(quantoff);
	       
	       JTextField quantoffText = new JTextField ("3");
	       ...
	       JLabel candyreq = new JLabel("Candy");
	       candyreq.setBounds(10,140,80,25);
	       panel.add(candyreq);
	       
	       
	       JTextField candyreqText = new JTextField ("(e.g. KitKat");
	       ...
	       JButton button = new JButton("Trick or Treat and Trade!");
...
//                
	    			...
	    			while (rs.next()) {
	    		           ...
	    		           Object[][] data = {
	    					...
	    					JPanel panel2 = new JPanel();
		    				   ...
		    				   JTable j = new JTable(new DefaultTableModel(new Object[]{"Name","CandyName","Quantity","CandyRequested","Quantity"}, qRequest));
	...
	try {
		//GUI enter: CandyName, Quantity, UserName, Requested CandyName, Requested Quantity
		//
        ...
        ResultSet rs = stmt.executeQuery("SELECT * FROM BUYING");
        System.out.println("name     candy name    qOffer   qRequest");
